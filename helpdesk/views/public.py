...
def ticketlist(request):
    ...
    ctickets = Ticket.objects.filter(submitter_email=request.user).order_by('id')
    context = {'ctickets': ctickets}
    return render(request, 'helpdesk/ticketlist.html', context)
