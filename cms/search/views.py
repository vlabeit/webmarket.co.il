...
from cms.services.models import ServicePage
...
def search(request):
    ...
    if search_query:
        if 'elasticsearch' in settings.WAGTAILSEARCH_BACKENDS['default']['BACKEND']:
            ...
            service_page_ids = [p.page_ptr.id for p in service_results]
            ...
            page_ids = blog_page_ids + service_page_ids + location_result_ids
